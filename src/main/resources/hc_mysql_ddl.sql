...
/* CONSTRAINT */
ALTER TABLE USER_ROLES ADD CONSTRAINT USER_ID_USER_ROLES_FK FOREIGN KEY (USER_ID) REFERENCES USER(ID);
ALTER TABLE USER_ROLES ADD CONSTRAINT USER_ID_USER_ROLES_UK UNIQUE KEY (ROLE,USERNAME);
