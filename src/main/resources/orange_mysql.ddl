...
ALTER TABLE ORDERED_ITEM ADD CONSTRAINT PRODUCT_ID_SHOPPING_LIST_FK FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCT(ID);
ALTER TABLE ORDERED_ITEM ADD CONSTRAINT USER_ACCOUNT_ID_SHOPPING_LIST_FK FOREIGN KEY (USER_ACCOUNT_ID) REFERENCES USER_ACCOUNT(ID);
ALTER TABLE PAY ADD CONSTRAINT USER_ACCOUNT_ID_PAY_FK FOREIGN KEY (USER_ACCOUNT_ID) REFERENCES USER_ACCOUNT(ID);
ALTER TABLE PAY ADD CONSTRAINT SHOPPING_LIST_ID_PAY_FK FOREIGN KEY (SHOPPING_LIST_ID) REFERENCES ORDERED_ITEM(ID);
/* CONSTRAINT */
