...
ID INT(10) AUTO_INCREMENT NOT NULL PRIMARY KEY,
ORDERD_QUANTITY INT(10),
STATUS INT(1),
SHOPPING_CART_DATE TIMESTAMP,
ORDERD_DATE TIMESTAMP,
...
ALTER TABLE SHOPPING_LIST ADD CONSTRAINT PRODUCT_ID_SHOPPING_LIST_FK FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCT(ID);
ALTER TABLE SHOPPING_LIST ADD CONSTRAINT USER_ACCOUNT_ID_SHOPPING_LIST_FK FOREIGN KEY (USER_ACCOUNT_ID) REFERENCES USER_ACCOUNT(ID);
ALTER TABLE PAY ADD CONSTRAINT USER_ACCOUNT_ID_PAY_FK FOREIGN KEY (USER_ACCOUNT_ID) REFERENCES USER_ACCOUNT(ID);
ALTER TABLE PAY ADD CONSTRAINT SHOPPING_LIST_ID_PAY_FK FOREIGN KEY (SHOPPING_LIST_ID) REFERENCES SHOPPING_LIST(ID);
/* CONSTRAINT */
